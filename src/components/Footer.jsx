...
function Footer() {
  ...
  return (
    <div className='w-[100%] font-Agbalumo text-sm border-t-2 flex justify-center items-center opacity-60 text-terracotta mt-4 border-opacity-10 border-terracotta h-[2.5rem]'>
