...
function RecipeCard({ name, ingredients, instructions, image, cuisineType, mealType }) {
    ...
    return (
        <div className="flex flex-col mt-6 w-[80%] lg:w-96 overflow-hidden border-4 rounded-lg shadow-lg box-border items-center shadow-red-300 snap-always snap-center">
            ...
            <div className="mt-5 text-center px-3">
                ...
                <p className="min-h-25 md:h-[10rem] font-sometypeMono font-medium overflow-y-auto text-left scrollbar scrollbar-w-[4px] scrollbar-thumb-red-300 scrollbar-thumb-rounded-lg">{ingredients.join(", ")}</p>
            </div>
